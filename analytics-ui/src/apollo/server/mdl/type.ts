...
export interface Manifest {
  ...
  dataSource?: AnalyticsEngineDataSourceType;
...
export enum AnalyticsEngineDataSourceType {
  ATHENA = 'ATHENA',
  BIGQUERY = 'BIGQUERY',
  CANNER = 'CANNER',
  ...
  DUCKDB = 'DUCKDB',
  REDSHIFT = 'REDSHIFT',
  // accepted by the analytics engine, but not supported by the analytics ui
